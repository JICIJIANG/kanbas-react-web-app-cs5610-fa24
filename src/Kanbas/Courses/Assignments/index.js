...
export default function Assignments() {
    return (
      <div id="wd-assignments">
        ...
        <button id="wd-add-assignment-group" aria-label="Add new assignment group">+ Group</button>
        <button id="wd-add-assignment" aria-label="Add new assignment">+ Assignment</button>
        <h3 id="wd-assignments-title">
          ASSIGNMENTS 40% of Total
        </h3>
        <button aria-label="Add new assignment">+</button>
