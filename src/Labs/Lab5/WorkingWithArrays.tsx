...
const REMOTE_SERVER = process.env.REACT_APP_REMOTE_SERVER || "http://localhost:5000";
      ...
      <h3>Retrieving Arrays</h3>
        ...
        <h3>Filtering Array Items</h3>
            ...
            <div className="mb-3">
                ...
                className="btn btn-primary-success float-end"
                >
                Update Description
                </a>
            </div>
            ...
            <br />
            <hr />
            <h3>Updating the Completed Status</h3>
